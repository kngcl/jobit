      ...
      <div className="w-full max-w-xs mx-auto">
        <form onSubmit={handleLogin} className="bg-white shadow-md rounded px-8 pt-8 pb-8 mb-4">
          ...
          <div className="flex items-center justify-between">
            <input
              className="bg-[#915EFF] w-full cursor-pointer hover:bg-violet-400 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              type="submit"
              value="Sign in"
            />
          ...
          <div className="mt-4">
            <Link to={"/signup"}>
              <p className="cursor-pointer"><u>Create an account</u></p>
            </Link>
